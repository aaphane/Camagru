...
<nav class="navbar navbar-default">
	<div class="container-fluid">
		...
		<div class="navbar-header">
			<button id="main-nav" type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="main_menu" aria-expanded="false">
		...
		<div class="collapse navbar-collapse" id="main_menu">
			...
			<ul class="nav navbar-nav navbar-right">
				<?php if (currentUser()) : ?>
					<li><a href="#">Ekse ma nikka!! <?= currentUser()->fname ?></a></li>
				<?php endif; ?>
			</ul>
		</div><!-- /.navbar-collapse -->
	</div><!-- /.container-fluid -->
